...
# dependencies. Here's an example integrated into a dependency auogeneration
...
# For this reason, it's strongly recommended you only do this when setting a
...
# only hash files in a project directory).
